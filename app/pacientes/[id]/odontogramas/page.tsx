    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex gap-2 ml-auto flex-wrap">
          {selected.length === 2 && (
            <button
              onClick={() => router.push(`/pacientes/${patientId}/odontogramas/compare?a=${selected[0]}&b=${selected[1]}`)}
          ...
          <Link href={`/pacientes/${patientId}`} className="px-4 py-2 rounded-xl text-sm font-medium border border-gray-200 text-gray-600 hover:bg-gray-50 transition">
            Ficha del paciente
          </Link>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          {!loading && rows.length === 0 && (
            <div className="card p-10 text-center">
              ...
              <Link href={`/pacientes/${patientId}/historia`} className="btn mt-4 inline-block text-sm">
  ...
  return (
    ...
    >
      ...
      <div className="p-3 space-y-2">
        ...
        <Link
          href={`/pacientes/${patientId}/odontogramas/${row.id}`}
