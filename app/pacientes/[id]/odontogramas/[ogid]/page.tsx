...
export default function Page({ params }: { params: { id: string; ogid: string } }) {
  ...
  if (!row) return (
    <div className="card p-8 text-center">
      ...
      <Link href={`/pacientes/${patientId}/odontogramas`} className="btn mt-4 inline-block text-sm">
        ← Volver al historial
      </Link>
    </div>
  )
